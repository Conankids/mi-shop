            ...
            <div class="checkout-addr">
                    ...
                    <div class="addr-list">
                        <ul>
                            <li v-for="(item,index) in addressListFilter"
                                :class="{'check':(curIndex == index)||(!curIndex&&item.isDefault)}"
                                @click="curIndex=index;checkedAddressId=item.addressId">
                                <dl>
                                    <dt>{{item.userName}}</dt>
                ...
                <div class="next-btn-wrap">
                    <router-link class="btn btn--m btn--red"
                                 :to="{path:'/orderConfirm',query:{addressId:checkedAddressId}}">Next
                    </router-link>
                </div>
            </div>
        </div>
        <Model :isShow.sync="delShow">
            <p slot="msg">
            ...
            <div slot="btnGroup">
                ...
                <a href="javascript:;" class="btn btn--m" @click="delShow = false">取消</a>
            </div>
        </Model>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            initAddress() {
                this.$http.get('/users/address').then(response => {
