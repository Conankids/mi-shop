<template>
    <div class="checkout cart-page">
                            ...
                            <li v-for="item in cartList">
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a href="javascipt:;" class="checkbox-btn item-check-btn"
                                           :class="{'check':item.checked==1}" @click="cartEdit('checked',item)">
                                    ...
                                    <div class="item-quantity">
                                        <div class="select-self select-self-open">
                                            <div class="select-self-area">
                                                <a class="input-sub" @click="cartEdit('reduce',item)">-</a>
                                ...
                                <div class="cart-tab-5">
                                    <div class="cart-item-opration">
                                        <a href="javascript:;" class="item-edit-btn" @click="showDel(item.productId)">
        ...
        <Model :isShow.sync="mdShowDel">
            ...
            <div slot="btnGroup">
                <a href="javascript:;" class="btn btn--m" @click="del">确认</a>
    ...
    export default {
        ...
        computed: {
            ...
            totalPrice() {
                ...
                this.cartList.forEach(item => {
                    if (item.checked == 1) {
                        tPrice += (item.salePrice * item.productNum)
                    }
                })
                return tPrice
            },
        ...
        methods: {
            ...
            toggleCheckAll() {
                ...
                this.$http.post('/users/cartCheckAll', {
                    checkedAll: flag
                }).then(response => {
                    const res = response.data
                    if (res.status == 0) {
                    ...
                    if (res.status == 0) {
                        ...
                        this.cartList.forEach(item => {
                            if (item.productId == this.curProductId) {
                                this.$store.commit('updateCartNum', -item.productNum)
                            }
                        })
                    }
                })
